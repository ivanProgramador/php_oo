<?php
  /*
   ...
   no primeiro bloco try faz uma tentativa de executar o codigo quye pode dar erro caso ele relamente de erro o cactch captura o erro salva em uma variavel e continua o resto da logica do sistema em questão
  ...
  try{
   ...
   // mysql_query($sql);
    ...
    /*Tambem exite a possibilidade de lançar erros de proposito para a aplicão
      ...
      o codigo abaixo usa uma funçao para testar se um arquivo existe essa função so retorna true ou false então o como ela vai retonar false porque o arquivo nao existe
